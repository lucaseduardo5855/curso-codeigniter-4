...
<div class="content-box">
    <?= form_open_multipart('/products_new_submit', ['novalidate' => true]) ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-12 p-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="text_description" id="text_description" class="form-control" placeholder="Descrição do produto">
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input list="list_categories" name="text_category" id="text_category" class="form-control" placeholder="Categoria">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_promotion" id="text_promotion" class="form-control" placeholder="Promoção">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-3">
                    ...
                    <input type="text" name="text_initial_stock" id="text_initial_stock" class="form-control" placeholder="Estoque inicial">
                </div>

                <div class="col-lg-6 col-12 mb-3">
                    <label for="stock_minimum_limit" class="form-label">Limite mínimo de estoque</label>
                    <input type="text" name="text_stock_minimum_limit" id="text_stock_minimum_limit" class="form-control" placeholder="Limite mínimo de estoque">
                </div>
